...
- UI построен как **"основной товар + аксессуары"**
- Триггер — всегда один товар (не группа, не условие по сумме)
- Add-ons — список с индивидуальными скидками для каждого
- Визуально напоминает upsell-конфигуратор, а не rule editor
