...
export enum GlobalIdEntity {
  ...
  OrderTaxLine = "OrderTaxLine",
  OrderPaymentAttempt = "OrderPaymentAttempt",
  OrderPaymentTransaction = "OrderPaymentTransaction",
  OrderPaymentDispute = "OrderPaymentDispute",
  FulfillmentOrder = "FulfillmentOrder",
  FulfillmentOrderLine = "FulfillmentOrderLine",
  ...
  OrderIntegrationLink = "OrderIntegrationLink",
  OrderOperation = "OrderOperation",
  OrderEditSession = "OrderEditSession",
  OrderEditChange = "OrderEditChange",
  // IAM
  User = "User",
  Customer = "Customer",
  ...
  RecommendationCalculationRun = "RecommendationCalculationRun",
  Option = "Option",
