...
const deserializeDeliveryProvider = (dto) => ({
    code: dto.code,
    data: dto.data,
});
const deserializeDeliveryMethod = (dto) => ({
    code: dto.code,
...
const deserializeDeliveryAddress = (dto) => {
    if (!dto)
        return null;
    return {
        id: dto.id,
...
const deserializeDeliveryGroup = (dto) => ({
    id: dto.id,
...
const deserializeCheckoutCost = (dto) => ({
    subtotalAmount: Money.fromJSON(dto.subtotalAmount),
...
const deserializeCustomerIdentity = (dto) => ({
    countryCode: dto.countryCode,
    customer: dto.customer,
    email: dto.email,
    phone: dto.phone,
});
const deserializeNotification = (dto) => ({
    id: dto.id,
    code: dto.code,
    severity: dto.severity,
    isDismissed: dto.isDismissed,
});
const deserializePromoCode = (dto) => ({
    code: dto.code,
...
export const deserializeCheckout = (dto) => ({
    id: dto.id,
