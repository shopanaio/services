# План перевода catalog backend бандлов на новые модели

## Цель

Перевести backend-код бандлов в `services/catalog` на модель базы данных, описанную в
...
## Фаза 8: Pricing and Currency rules
...
## Фаза 9: Events and Search Index
...
## Фаза 10: Codegen, Build and Verification
...
## Фаза 11: Rollout strategy

Рекомендуемый rollout:

1. Добавить новые repositories и scripts за новыми GraphQL operations.
2. Временно оставить старые GraphQL operations только если catalog consumers все еще от них зависят.
3. Пометить старые operations deprecated в schema comments.
4. Удалить legacy operations после перехода consumers на configuration-scoped API.
