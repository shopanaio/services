...
export type NavigationMenuItemTranslationRecord = Readonly<NavigationMenuItemTranslationModel>;

export type NavigationItemTarget =
  Readonly<{ type: "URL"; url: string }> | Readonly<{ type: string; id: string }>;
