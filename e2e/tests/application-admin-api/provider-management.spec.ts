...
test.describe('Application Admin API - social provider management', () => {
  ...
  test('provider catalog exposes only supported closed enum values', async ({
    api,
  }) => {
  ...
  test('unconfigured provider status is readable without secret fields', async ({
    api,
  }) => {
  ...
  test('provider configure stores encrypted credentials and returns only masked client ID', async ({
    api,
  }) => {
  ...
  test('provider configure rejects unsupported scopes before storing credentials', async ({
    api,
  }) => {
  ...
  test('provider configure rejects unknown provider before repository mutation', async ({
    api,
    request,
  }) => {
  ...
  test('provider cannot be configured twice without explicit credential rotation', async ({
    api,
  }) => {
  ...
  test('provider enable requires stored credentials and catalog-approved scopes', async ({
    api,
  }) => {
  ...
  test('provider disable cannot remove the last sign-in method while realm is enabled', async ({
    api,
  }) => {
    await configureProvider(api, scope.applicationA);
  ...
  test('provider credentials rotate updates encrypted credentials without exposing secret values', async ({
    api,
  }) => {
    await configureProvider(api, scope.applicationA);
  ...
  test('provider credentials delete is allowed only after provider is disabled', async ({
    api,
  }) => {
    await configureProvider(api, scope.applicationA);
    await updateProvider(api, scope.applicationA, 'GOOGLE', { enabled: true });
  ...
  test('provider credentials delete removes runtime availability without deleting unrelated provider audit history', async ({
    api,
  }) => {
    await configureProvider(api, scope.applicationA);
  ...
  test('provider validation returns VALID with safe metadata for a valid external configuration', async ({
    api,
  }) => {
  ...
  test('provider validation returns INVALID reason code without exposing upstream response or secret', async ({
    api,
  }) => {
  ...
  test('provider validation returns UNAVAILABLE without changing stored provider state', async ({
    api,
  }) => {
    await configureProvider(api, scope.applicationA, 'GOOGLE', {
  ...
  test('provider callback URL is exact, application-scoped, and uses IAM public base URL', async ({
    api,
  }) => {
    const application = required(await getApplication(api, scope.applicationA), 'application');
  ...
  test('provider query requires org.application-auth-providers read permission', async ({
    api,
  }) => {
  ...
  test('provider write and credential mutations enforce write versus admin permission split', async ({
    api,
  }) => {
    await configureProvider(api, scope.applicationA);
  ...
  test('provider mutation with organizationId of another owner returns safe not-found or forbidden behavior', async ({
    api,
  }) => {
  ...
  test('provider state change invalidates the target application runtime and not another application', async ({
    api,
    request,
  }) => {
  ...
  test('provider admin audit safeDiff never includes client secret, full client ID, tokens, or upstream payload', async ({
    api,
  }) => {
