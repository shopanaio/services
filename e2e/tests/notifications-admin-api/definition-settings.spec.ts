...
definePendingContractSuite("Notifications Admin API - definitions", [
  [
    "NTF-DEF-001",
    "definitions returns every registered notification definition in deterministic order",
  ],
  ["NTF-DEF-002", "definition exposes key, title, audience, optional flag, and variables"],
  [
    "NTF-DEF-003",
    "definition allowedChannels and defaultChannels match the server registry contract",
  ],
  ...
  ["NTF-DEF-006", "setDefinitionEnabled creates the first override"],
  ["NTF-DEF-007", "successful definition update persists the requested state"],
  ["NTF-DEF-010", "mandatory definition cannot be disabled"],
  ["NTF-DEF-011", "optional definition can be disabled and re-enabled"],
  [
    "NTF-DEF-012",
    "unknown definition key returns INVALID_NOTIFICATION_DEFINITION on the key field",
  ],
  ["NTF-DEF-013", "definition override in Store A does not change effective state in Store B"],
  [
    "NTF-DEF-014",
    "definition mutation updates request-local loader state before payload resolution",
  ],
