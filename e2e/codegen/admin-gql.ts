...
export type OnlineStoreNavigationMenuOrderField =
  /** Sort by createdAt */
  | 'createdAt'
  /** Sort by handle */
  | 'handle'
...
export type OnlineStorePageOrderField =
  /** Sort by createdAt */
  | 'createdAt'
  /** Sort by handle */
  | 'handle'
...
export type PriceAdjustmentValueType =
 ...
 */
export type ProductComponentOperationAction =
  | 'CONFIGURATION_CREATE'
  | 'CONFIGURATION_DELETE'
  | 'CONFIGURATION_UPDATE'
  | 'DEPENDENCY_RULES_SYNC'
  | 'GROUPS_SYNC'
  | 'PRICING_TEMPLATES_SYNC'
  | 'REMOVE'
  | 'SETTINGS_UPDATE';
...
export type ProductOptionCategoryOrderField =
  /** Sort by createdAt */
  | 'createdAt'
  /** Sort by id */
  | 'id'
...
export type SearchProductBoostOrderField =
  /** Sort by createdAt */
  | 'createdAt'
  /** Sort by enabled */
  | 'enabled'
...
export type SearchSynonymGroupOrderField =
  /** Sort by createdAt */
  | 'createdAt'
  /** Sort by enabled */
  | 'enabled'
