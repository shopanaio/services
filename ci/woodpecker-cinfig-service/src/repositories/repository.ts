...
export class BitBucketRepository extends Repository {
  ...
  /**
   * Checks if there is an open pull request from source to target branch in Bitbucket.
   */
...
export class GitHubRepository extends Repository {
  ...
  /**
   * Checks if there is an open pull request from source to target branch in GitHub.
   */
  async hasOpenPullRequest(sourceBranch: string, targetBranch: string): Promise<boolean> {
