...
} from '@remirror/extension-heading';
import { useActive, useCommands } from '@remirror/react-core';

import { CommandMenuItem, CommandMenuItemProps } from './CmdMenuItem';
...
export const ToggleHeadingMenuItem: FC<ToggleHeadingMenuItemProps> = ({
  attrs,
  ...rest
}) => {
