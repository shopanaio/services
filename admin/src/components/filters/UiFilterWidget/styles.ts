...
const filterNodeCenterWrapper = css`
  --bg: var(--color-gray-1);
  height: 30px;
  display: flex;
  align-items: center;
...
const operatorTag = css`
  display: block;
  min-width: 30px !important;
  text-align: center;
`;

const filterNodeRight = css`
  display: flex;
  align-items: center;
  padding: 0 var(--x1);
