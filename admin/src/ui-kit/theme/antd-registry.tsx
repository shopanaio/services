...
import { StyleProvider as AntdStyleProvider, extractStaticStyle } from "antd-style";
...
export function AntdRegistry({ children }: { children: React.ReactNode }) {
  ...
  return (
    <BaseAntdRegistry>
      <AntdStyleProvider cache={extractStaticStyle.cache}>{children}</AntdStyleProvider>
    </BaseAntdRegistry>
  );
}
