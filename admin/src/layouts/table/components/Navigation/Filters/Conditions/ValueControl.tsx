...
import { RelationControl } from '@src/layouts/table/components/Navigation/Filters/Conditions/RelationControl';
...
export const FilterValueControl = ({
  ...
  if (type === UiFilter.UiFilterType.Date) {
  ...
  if (filter?.options?.length) {
    return (
      <Select
        ...
        value={value}
        onChange={onChange}
        maxTagCount={isMultiple ? undefined : 1}
  ...
  if (type === UiFilter.UiFilterType.Number) {
