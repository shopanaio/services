...
export interface ManagementUserError {
  code: string;
  field?: string[] | null;
  message: string;
}
export interface ReviewConfiguration {
  ...
  questionEditWindowHours: number;
  answerEditWindowHours: number;
  maxReviewMediaCount: number;
