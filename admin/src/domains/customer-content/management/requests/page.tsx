...
export default function ReviewRequestsPage() {
  ...
  return <DataLayout fullWidth name="review-requests" title="Review requests" count={connection?.totalCount ?? 0} actions={<Button icon={<PlusOutlined />} onClick={() => push({ onSaved: query.refetch })}>Create request</Button>}>
