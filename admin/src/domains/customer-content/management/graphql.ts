...
const USER_ERRORS = gql`
  fragment CustomerContentUserErrorFields on GenericUserError {
    code
    field
    message
  }
  ...
  mutation AdminReviewConfigurationUpdate(
    ...
    reviewsMutation {
      storeConfigurationUpdate(
        ...
        operationResults {
          errors {
            ...CustomerContentUserErrorFields
          }
        }
        userErrors {
          ...CustomerContentUserErrorFields
...
export const RATING_CRITERIA_QUERY = gql`
  query AdminRatingCriteria {
    reviewsQuery {
      ratingCriteria(first: 100, orderBy: [{ field: sortIndex, direction: asc }]) {
        totalCount
        edges {
          node {
            id
...
export const RATING_CRITERION_CREATE_MUTATION = gql`
  mutation AdminRatingCriterionCreate($input: ReviewRatingCriterionCreateInput!) {
    reviewsMutation {
      ratingCriterionCreate(input: $input) {
        criterion {
          id
          updatedAt
        }
...
export const RATING_CRITERION_UPDATE_MUTATION = gql`
  mutation AdminRatingCriterionUpdate(
    $criterionId: ID!
...
export const RATING_CRITERION_DELETE_MUTATION = gql`
  mutation AdminRatingCriterionDelete($input: ReviewRatingCriterionDeleteInput!) {
    reviewsMutation {
      ratingCriterionDelete(input: $input) {
        deletedCriterionId
        userErrors {
          ...CustomerContentUserErrorFields
        }
  ...
  query AdminModerationContents(
    ...
    reviewsQuery {
      contents(
        ...
        where: $where
        orderBy: $orderBy
        meta: { includeDeleted: true, includeRedacted: true }
      ) {
        totalCount
        edges {
          cursor
...
export const CONTENT_REPORT_UPDATE_MUTATION = gql`
  mutation AdminContentReportUpdate(
    $contentReportId: ID!
    $expectedUpdatedAt: DateTime!
...
export const MODERATION_CASE_CREATE_MUTATION = gql`
  mutation AdminModerationCaseCreate($input: ReviewModerationCaseCreateInput!) {
    reviewsMutation {
      moderationCaseCreate(input: $input) {
        moderationCase {
          id
          updatedAt
        }
...
export const MODERATION_CASE_UPDATE_MUTATION = gql`
  mutation AdminModerationCaseUpdate(
    $moderationCaseId: ID!
    $expectedUpdatedAt: DateTime!
...
export const REVIEW_REQUEST_CREATE_MUTATION = gql`
  mutation AdminReviewRequestCreate($input: ReviewRequestCreateInput!) {
    reviewsMutation {
      reviewRequestCreate(input: $input) {
        reviewRequest {
          id
          updatedAt
        }
...
export const REVIEW_REQUEST_UPDATE_MUTATION = gql`
  mutation AdminReviewRequestUpdate(
    $reviewRequestId: ID!
    $expectedUpdatedAt: DateTime!
...
export const EXTERNAL_REFERENCE_CREATE_MUTATION = gql`
  mutation AdminExternalReferenceCreate($input: ReviewContentExternalReferenceCreateInput!) {
    reviewsMutation {
      contentExternalReferenceCreate(input: $input) {
        externalReference {
          id
          updatedAt
        }
...
export const EXTERNAL_REFERENCE_UPDATE_MUTATION = gql`
  mutation AdminExternalReferenceUpdate(
    $externalReferenceId: ID!
    $expectedUpdatedAt: DateTime!
    $operations: ReviewContentExternalReferenceUpdateInput
  ) {
    reviewsMutation {
...
export const EXTERNAL_REFERENCE_DELETE_MUTATION = gql`
  mutation AdminExternalReferenceDelete($input: ReviewContentExternalReferenceDeleteInput!) {
    reviewsMutation {
      contentExternalReferenceDelete(input: $input) {
        deletedExternalReferenceId
        userErrors {
          ...CustomerContentUserErrorFields
        }
      }
...
export const QUESTION_SUBSCRIPTION_UPDATE_MUTATION = gql`
  mutation AdminQuestionSubscriptionUpdate(
    $subscriptionId: ID!
    $expectedUpdatedAt: DateTime!
