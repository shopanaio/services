...
export default function ExternalReferencesPage() {
  ...
  return <DataLayout fullWidth name="external-references" title="External sync" count={connection?.totalCount ?? 0} actions={<Button icon={<PlusOutlined />} onClick={() => push({ onSaved: query.refetch })}>Add reference</Button>}>
