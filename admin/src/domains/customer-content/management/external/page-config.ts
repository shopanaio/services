...
import type { ApiReviewContentExternalReferenceOrderByInput, ApiReviewContentExternalReferenceWhereInput } from "@/graphql/types";
...
export const buildExternalReferenceSearchCondition = (search: string): Partial<ApiReviewContentExternalReferenceWhereInput> => ({
  _or: [
...
export function buildExternalReferencesQueryVariables(
  pageConfig: Pick<UsePageConfigReturn<ApiReviewContentExternalReferenceWhereInput, ReviewContentExternalReferenceOrderField>, "first" | "after" | "last" | "before" | "where" | "orderBy">,
): ExternalReferencesQueryVariables {
  return { ...pageConfig, where: pageConfig.where ?? null, orderBy: pageConfig.orderBy as ApiReviewContentExternalReferenceOrderByInput[] | undefined };
}
