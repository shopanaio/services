...
export const filterSchema: IFilterSchema[] = [
  {
    ...
    payloadKey: "syncStatus",
    options: enumOptions(Object.values(ReviewExternalSyncStatus)),
  },
  {
    key: "direction",
    label: "Direction",
    description: "Filter by synchronization direction",
    type: FilterType.Enum,
    operators: enumOperators,
    payloadKey: "direction",
    options: enumOptions(Object.values(ReviewExternalSyncDirection)),
  },
  {
    key: "externalSystem",
    ...
    payloadKey: "externalSystem",
  },
  {
    key: "externalType",
    label: "External type",
    description: "Filter by external content type",
    type: FilterType.String,
    operators: stringOperators,
    payloadKey: "externalType",
  },
  {
    key: "lastSyncedAt",
    label: "Last sync date",
    description: "Filter by last successful sync date",
    type: FilterType.DateRange,
    operators: dateOperators,
    payloadKey: "lastSyncedAt",
  },
  {
    key: "updatedAt",
    label: "Updated date",
    description: "Filter by reference update date",
    type: FilterType.DateRange,
    operators: dateOperators,
