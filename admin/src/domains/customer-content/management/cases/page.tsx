...
export default function ModerationCasesPage() {
  ...
  return <DataLayout fullWidth name="moderation-cases" title="Moderation cases" count={connection?.totalCount ?? 0} actions={<Button icon={<PlusOutlined />} onClick={() => push({ onSaved: query.refetch })}>Create case</Button>}>
