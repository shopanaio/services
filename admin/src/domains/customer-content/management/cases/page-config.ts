...
import type { ApiReviewModerationCaseOrderByInput, ApiReviewModerationCaseWhereInput } from "@/graphql/types";
...
export const buildModerationCaseSearchCondition = (search: string): Partial<ApiReviewModerationCaseWhereInput> => ({
  _or: [
...
export function buildModerationCasesQueryVariables(
  pageConfig: Pick<UsePageConfigReturn<ApiReviewModerationCaseWhereInput, ReviewModerationCaseOrderField>, "first" | "after" | "last" | "before" | "where" | "orderBy">,
): ModerationCasesQueryVariables {
  return { ...pageConfig, where: pageConfig.where ?? null, orderBy: pageConfig.orderBy as ApiReviewModerationCaseOrderByInput[] | undefined };
}
