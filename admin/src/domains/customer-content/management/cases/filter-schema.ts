...
export const filterSchema: IFilterSchema[] = [
  {
    ...
    payloadKey: "status",
    options: Object.values(ReviewModerationCaseStatus).map((value) => ({
  ...
  },
  {
    key: "priority",
    label: "Priority",
    description: "Filter by moderation priority",
  ...
  },
  {
    key: "reasonCode",
    label: "Reason code",
    description: "Filter by case reason code",
    type: FilterType.String,
    operators: stringOperators,
    payloadKey: "reasonCode",
  },
  {
    key: "assignee",
  ...
  },
  {
    key: "createdAt",
    label: "Created date",
    description: "Filter by case creation date",
    type: FilterType.DateRange,
    operators: dateOperators,
