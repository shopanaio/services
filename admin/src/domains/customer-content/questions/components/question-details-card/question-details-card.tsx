...
export function QuestionDetailsCard({ question, onEdit, onDelete, onRedact, onManageExternalReferences, onUpdateSubscription }: QuestionDetailsCardProps) {
  ...
  return <Flex vertical gap={12} style={{ width: "100%" }} data-testid="question-details-card">
    ...
    <ContentDetailsSections content={question} onManageExternalReferences={onManageExternalReferences} />
  </Flex>;
}
