...
const options = <T extends string>(values: T[]) =>
...
export const filterSchema: IFilterSchema[] = [
  ...
  },
  {
    ...
    options: options(Object.values(OrderPaymentStatus)),
  },
  {
    ...
    options: options(Object.values(OrderFulfillmentStatus)),
  },
  {
    key: "createdAt",
    label: "Created",
  ...
  },
  {
    ...
    type: FilterType.Enum,
    operators: enumOperators,
    payloadKey: "currencyCode",
    options: options(["USD", "EUR", "UAH"]),
  },
  {
    key: "shippingCountry",
