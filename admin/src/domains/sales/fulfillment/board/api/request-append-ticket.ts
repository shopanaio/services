import type {
  ...
  FulfillmentTicketAppendPayload,
} from "../graphql/operation-types";
import { fulfillmentMockStore, runFulfillmentMockTransport } from "../mocks";

export async function requestAppendFulfillmentTicket(
  input: FulfillmentTicketAppendInput,
): Promise<FulfillmentTicketAppendPayload> {
