...
export const fulfillmentFilterSchema: IFilterSchema[] = [
  {
    ...
    options: options(Object.values(FulfillmentOrderStatus)),
  },
  {
    key: "paymentStatus",
    ...
    options: options(Object.values(FulfillmentPaymentStatus)),
  },
  {
    ...
    options: options(Object.values(FulfillmentStatus)),
  },
  {
    key: "createdAt",
    label: "Created",
