...
import VirtualList, { type ItemInfo } from "react-tiny-virtual-list";
import AutoSizer from "react-virtualized-auto-sizer";
import { type RenderItem, Item } from "./item";
import type { RenderColumn } from "./container";
...
export const Boards = ({
  ...
  function renderSortableItemDragOverlay(id: UniqueIdentifier) {
    return <Item key={String(id)} value={id} dragOverlay renderItem={renderItem} />;
  }
...
export const MultipleContainers = Boards;
