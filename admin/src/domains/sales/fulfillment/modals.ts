...
import type { OrderFulfillmentStatusModalPayload, OrderModalPayload, OrderShippingItemModalPayload } from "@/domains/sales/all-orders/modals";
...
export interface FulfillmentStageModalPayload extends IModalStackPayload { mode: "create" | "edit"; entityId?: string; initialSortIndex?: number; onSaved?: () => Promise<unknown> | unknown }
export type FulfillmentOrderModalPayload = OrderModalPayload;
export interface FulfillmentStatusModalPayload extends OrderFulfillmentStatusModalPayload { targetStatus?: OrderFulfillmentStatus }
