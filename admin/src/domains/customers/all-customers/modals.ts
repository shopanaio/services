...
import type {
  ...
  CustomerTaxExemptionDraft,
  CustomerTaxIdentifierDraft,
} from "./modals/shared/customer-drafts";
...
export interface CustomerSectionModalPayload extends IModalStackPayload {
  entityId: string;
  onSaved?: () => Promise<unknown> | unknown;
}
export interface CustomerAddressItemModalPayload extends IModalStackPayload {
  item: CustomerAddressDraft;
  title: string;
  onApply: (item: CustomerAddressDraft) => void;
}
export interface CustomerTaxIdentifierItemModalPayload extends IModalStackPayload {
  item: CustomerTaxIdentifierDraft;
  title: string;
  onApply: (item: CustomerTaxIdentifierDraft) => void;
}
export interface CustomerTaxExemptionItemModalPayload extends IModalStackPayload {
  item: CustomerTaxExemptionDraft;
  title: string;
  onApply: (item: CustomerTaxExemptionDraft) => void;
}
...
export const useCustomerManageAddressesModal = createModalStackHook(
  CUSTOMER_MANAGE_ADDRESSES_MODAL_TYPE,
);
...
export const useCustomerEditModerationModal = createModalStackHook(
  CUSTOMER_EDIT_MODERATION_MODAL_TYPE,
);
export const useCustomerManageTaxIdentifiersModal = createModalStackHook(
  CUSTOMER_MANAGE_TAX_IDENTIFIERS_MODAL_TYPE,
);
export const useCustomerEditTaxIdentifierModal = createModalStackHook(
  CUSTOMER_EDIT_TAX_IDENTIFIER_MODAL_TYPE,
);
export const useCustomerManageTaxExemptionsModal = createModalStackHook(
  CUSTOMER_MANAGE_TAX_EXEMPTIONS_MODAL_TYPE,
);
export const useCustomerEditTaxExemptionModal = createModalStackHook(
  CUSTOMER_EDIT_TAX_EXEMPTION_MODAL_TYPE,
);
export const useCustomerTechnicalMetadataModal = createModalStackHook(
  CUSTOMER_TECHNICAL_METADATA_MODAL_TYPE,
);
