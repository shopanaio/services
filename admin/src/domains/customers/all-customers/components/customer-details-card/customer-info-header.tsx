  ...
  return (
    <Tooltip title={label}>
      <span aria-label={label} role="img">
        <VerifiedOutlined
          style={{
            color: verified ? "var(--ant-color-success)" : "var(--ant-color-text-tertiary)",
          }}
        />
      </span>
    </Tooltip>
...
export function CustomerInfoHeader({
  ...
  const terminal =
    customer.lifecycleStatus === CustomerLifecycleStatus.Merged ||
    customer.lifecycleStatus === CustomerLifecycleStatus.Redacted;
  ...
  const menuItems = [
    {
      ...
      "data-testid": "customer-edit-profile-menu-item",
      onClick: () => onEdit("profile"),
    },
    {
      key: "contact",
      label: "Edit contact details",
      "data-testid": "customer-edit-contact-menu-item",
      onClick: () => onEdit("contact"),
    },
    {
      key: "company",
      label: "Edit company",
      "data-testid": "customer-edit-company-menu-item",
      onClick: () => onEdit("company"),
    },
    {
      key: "addresses",
      label: "Manage addresses",
      "data-testid": "customer-manage-addresses-menu-item",
    ...
    { type: "divider" as const },
    {
      ...
      "data-testid": "customer-edit-consents-menu-item",
      onClick: () => onEdit("consents"),
    },
    {
      key: "groups",
      label: "Edit customer groups",
      "data-testid": "customer-edit-groups-menu-item",
      onClick: () => onEdit("groups"),
    },
    {
      key: "tags",
      label: "Edit customer tags",
      "data-testid": "customer-edit-tags-menu-item",
      onClick: () => onEdit("tags"),
    },
    {
      key: "segments",
      label: "Edit manual segments",
      "data-testid": "customer-edit-segments-menu-item",
    ...
    { type: "divider" as const },
    {
      ...
      "data-testid": "customer-edit-status-menu-item",
      disabled: terminal,
      onClick: () => onEdit("status"),
    },
    {
      key: "note",
      label: "Edit merchant note",
      "data-testid": "customer-edit-note-menu-item",
      onClick: () => onEdit("note"),
    },
    {
      key: "moderation",
      label: "Edit moderation note",
      "data-testid": "customer-edit-moderation-menu-item",
      onClick: () => onEdit("moderation"),
    },
    {
      key: "tax-identifiers",
      label: "Manage tax identifiers",
      "data-testid": "customer-manage-tax-identifiers-menu-item",
      onClick: () => onEdit("taxIdentifiers"),
    },
    {
      key: "tax-exemptions",
      label: "Manage tax exemptions",
      "data-testid": "customer-manage-tax-exemptions-menu-item",
      onClick: () => onEdit("taxExemptions"),
    },
    {
      key: "metadata",
      label: "View technical metadata",
      "data-testid": "customer-technical-metadata-menu-item",
      onClick: onTechnicalMetadata,
    },
    { type: "divider" as const },
    {
      key: "delete",
      ...
      danger: true,
      "data-testid": "customer-delete-menu-item",
      onClick: onDelete,
    },
  ];
  ...
  return (
    <Paper data-testid="customer-header-section">
        ...
        <Flex vertical gap={6} className={styles.identity}>
          ...
          <Flex align="center" gap={12} wrap="wrap" className={styles.contactLine}>
            {customer.email ? (
              <span className={styles.contact}>
                <Typography.Text copyable={{ text: customer.email }}>
                  {customer.email}
                </Typography.Text>
            ...
            {customer.phoneE164 ? (
              <span className={styles.contact}>
                <Typography.Text copyable={{ text: customer.phoneE164 }}>
                  {customer.phoneE164}
                </Typography.Text>
          ...
          <Flex gap={8} wrap="wrap">
            ...
            <CopyableChip
              label="ID"
              value={customer.id}
              displayValue={shortCustomerId(customer.id)}
              mono
            />
          </Flex>
        </Flex>
      ...
      <div className={styles.kpiGrid}>
        <KPITile
          label="Orders"
          value={customer.statistics?.ordersCount ?? 0}
          centered
          className={styles.kpiTile}
        />
        <KPITile
          label="Net spent"
          value={formatCustomerMoney(money?.netSpentMinor, currency)}
          centered
          className={styles.kpiTile}
        />
        <KPITile
          label="Avg. order"
          value={formatCustomerMoney(money?.averageOrderValueMinor, currency)}
          centered
          className={styles.kpiTile}
        />
        <KPITile
          label="Returns"
          value={customer.statistics?.returnsCount ?? 0}
          centered
          className={styles.kpiTile}
        />
      </div>
