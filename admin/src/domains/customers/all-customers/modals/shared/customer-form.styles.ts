...
export const useCustomerFormStyles = createStyles(({ token }) => ({
  ...
  statusOption: {
    ...
    "@media (max-width: 480px)": {
      "&:first-child": { borderRadius: `${token.borderRadiusLG}px ${token.borderRadiusLG}px 0 0` },
      "&:last-child": { borderRadius: `0 0 ${token.borderRadiusLG}px ${token.borderRadiusLG}px` },
    },
  },
  consequence: {
