        ...
        <div className={styles.container}>
          ...
          <Paper>
            ...
            <div className={styles.fields}>
              <div>
                <label className={styles.label} htmlFor="new-customer-first-name">
                  First name
                </label>
                <Controller
                  name="firstName"
              ...
              <div>
                <label className={styles.label} htmlFor="new-customer-last-name">
                  Last name
                </label>
                <Controller
                  name="lastName"
              ...
              <div>
                <label className={styles.label} htmlFor="new-customer-email">
                  Email
                </label>
                <Controller
                  name="email"
              ...
              <div>
                <label className={styles.label} htmlFor="new-customer-phone">
                  Phone
                </label>
                <Controller
                  name="phoneE164"
                  ...
                  render={({ field }) => (
                    <Input
                      ...
                      type="tel"
                      status={errors.phoneE164 ? "error" : undefined}
                    />
                  )}
                />
                {errors.phoneE164 ? (
                  <div className={styles.error}>{errors.phoneE164.message}</div>
                ) : null}
              </div>
              <div className={styles.full}>
                <label className={styles.label} htmlFor="new-customer-locale">
                  Preferred locale
                </label>
                <Controller
