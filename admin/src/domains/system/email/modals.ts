...
export const DELETE_EMAIL_TEMPLATE_MODAL_TYPE =
  "system-delete-email-template";
...
export const useEditEmailSettingsModal = createModalStackHook(
  EDIT_EMAIL_SETTINGS_MODAL_TYPE,
);
export const useEditSmtpProfileModal = createModalStackHook(
  EDIT_SMTP_PROFILE_MODAL_TYPE,
);
export const useEmailTemplateModal = createModalStackHook(
  EMAIL_TEMPLATE_MODAL_TYPE,
);
export const useSendTestEmailModal = createModalStackHook(
  SEND_TEST_EMAIL_MODAL_TYPE,
);
export const useDeleteEmailTemplateModal = createModalStackHook(
  DELETE_EMAIL_TEMPLATE_MODAL_TYPE,
);
