...
export const ADD_STORE_LANGUAGE_MODAL_TYPE =
  "general-settings-add-store-language";
export const EDIT_CUSTOMER_ACCOUNTS_MODAL_TYPE =
  "general-settings-edit-customer-accounts";
...
export const useAddStoreLanguageModal = createModalStackHook(
  ADD_STORE_LANGUAGE_MODAL_TYPE,
);
...
export const useEditCustomerAccountsModal = createModalStackHook(
  EDIT_CUSTOMER_ACCOUNTS_MODAL_TYPE,
);
