export { CUSTOMER_ACCOUNTS_SETTINGS_FRAGMENT, GENERAL_SETTINGS_STORE_FRAGMENT } from "./fragments";
export { CUSTOMER_ACCOUNTS_SETTINGS_QUERY, GENERAL_SETTINGS_QUERY } from "./queries";
