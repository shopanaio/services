...
export function getModalStackDefinitions(): IModalStackDefinition[] {
  return [
    ...
    // ========================================
    {
      ...
      component: dynamic(() =>
        import("@/domains/media/navigation/modals/menu-modal").then((m) => m.NavigationMenuModal),
      ),
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/media/navigation/modals/link-modal").then((m) => m.NavigationLinkModal),
      ),
      confirmOnDirtyClose: true,
    ...
    // Invite Member modal
    {
      ...
      component: dynamic(() =>
        import("@/domains/workspace/modals/invite-member-modal").then((m) => m.InviteMemberModal),
      ),
    },
    // Role modal (unified create/edit/view)
    {
      type: "workspace-role",
      component: dynamic(() =>
        import("@/domains/workspace/modals/role-modal").then((m) => m.RoleModal),
      ),
    },
    ...
    // Change Password modal
    {
      ...
      component: dynamic(() =>
        import("@/domains/profile/modals/change-password-modal").then((m) => m.ChangePasswordModal),
      ),
    },
    // Change Email modal
    {
      ...
      component: dynamic(() =>
        import("@/domains/profile/modals/change-email-modal").then((m) => m.ChangeEmailModal),
      ),
    },
    // Edit Avatar modal
    {
      ...
      component: dynamic(() =>
        import("@/domains/profile/modals/edit-avatar-modal").then((m) => m.EditAvatarModal),
      ),
    },
    ...
    // Edit Profile modal
    {
      ...
      component: dynamic(() =>
        import("@/domains/profile/modals/edit-profile-modal").then((m) => m.EditProfileModal),
      ),
    },
    // Create Store modal
    {
      ...
      component: dynamic(() =>
        import("@/domains/workspace/modals/create-store-modal").then((m) => m.CreateStoreModal),
      ),
    },
    ...
    // Product modal
    {
      type: "product",
      component: dynamic(() =>
        import("@/domains/inventory/products/modals/product-modal").then((m) => m.ProductModal),
      ),
    },
    ...
    // AI Writer modal
    {
      ...
      component: dynamic(() =>
        import("@/domains/inventory/products/modals/ai-writer-modal").then((m) => m.AIWriterModal),
      ),
    },
    // Price History modal
    {
    ...
    // Edit SEO modal
    {
      ...
      component: dynamic(() =>
        import("@/domains/inventory/products/modals/edit-seo-modal").then((m) => m.EditSeoModal),
      ),
    },
    ...
    // Edit Tags modal
    {
      ...
      component: dynamic(() =>
        import("@/domains/inventory/products/modals/edit-tags-modal").then((m) => m.EditTagsModal),
      ),
    },
    {
    ...
    // Category modal
    {
      type: "category",
      component: dynamic(() =>
        import("@/domains/inventory/categories/modals/category-modal").then((m) => m.CategoryModal),
      ),
    },
    ...
    // ========================================
    {
      type: "discount",
      component: dynamic(() =>
        import("@/domains/inventory/discounts/modals/discount-modal").then((m) => m.DiscountModal),
      ),
    },
    {
    ...
    // Tag modal
    {
      type: "tag",
      component: dynamic(() =>
        import("@/domains/inventory/tags/modals/tag-modal").then((m) => m.TagModal),
      ),
    },
    // Create Tag modal
    {
      type: "tag-create",
      component: dynamic(() =>
        import("@/domains/inventory/tags/modals/create-tag-modal").then((m) => m.CreateTagModal),
      ),
    },
    ...
    },
    {
      type: "facet-edit",
      component: dynamic(() =>
        import("@/domains/discovery/facets/modals/edit-facet-modal").then((m) => m.EditFacetModal),
      ),
    },
    {
    ...
    // ========================================
    {
      ...
      component: dynamic(() =>
        import("@/domains/discovery/search/product-boosts/modals").then((m) => m.ProductBoostModal),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/discovery/search/synonyms/modals").then((m) => m.SynonymGroupModal),
      ),
      confirmOnDirtyClose: true,
      closeConfirmMessage: "Discard unsaved changes?",
    },
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customers/all-customers/modals/edit-customer-profile-modal").then(
          (m) => m.EditCustomerProfileModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customers/all-customers/modals/edit-customer-contact-modal").then(
          (m) => m.EditCustomerContactModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customers/all-customers/modals/edit-customer-company-modal").then(
          (m) => m.EditCustomerCompanyModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customers/all-customers/modals/manage-customer-addresses-modal").then(
          (m) => m.ManageCustomerAddressesModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customers/all-customers/modals/edit-customer-address-modal").then(
          (m) => m.EditCustomerAddressModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customers/all-customers/modals/edit-customer-consents-modal").then(
          (m) => m.EditCustomerConsentsModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customers/all-customers/modals/edit-customer-groups-modal").then(
          (m) => m.EditCustomerGroupsModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customers/all-customers/modals/edit-customer-tags-modal").then(
          (m) => m.EditCustomerTagsModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customers/all-customers/modals/edit-customer-segments-modal").then(
          (m) => m.EditCustomerSegmentsModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customers/all-customers/modals/edit-customer-status-modal").then(
          (m) => m.EditCustomerStatusModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customers/all-customers/modals/edit-customer-note-modal").then(
          (m) => m.EditCustomerNoteModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customers/all-customers/modals/edit-customer-moderation-modal").then(
          (m) => m.EditCustomerModerationModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customers/all-customers/modals/manage-customer-tax-identifiers-modal").then(
          (m) => m.ManageCustomerTaxIdentifiersModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customers/all-customers/modals/edit-customer-tax-identifier-modal").then(
          (m) => m.EditCustomerTaxIdentifierModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customers/all-customers/modals/manage-customer-tax-exemptions-modal").then(
          (m) => m.ManageCustomerTaxExemptionsModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customers/all-customers/modals/edit-customer-tax-exemption-modal").then(
          (m) => m.EditCustomerTaxExemptionModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customers/all-customers/modals/customer-technical-metadata-modal").then(
          (m) => m.CustomerTechnicalMetadataModal,
        ),
      ),
    },
    {
    ...
    },
    {
      type: "customer-group",
      component: dynamic(() =>
        import("@/domains/customers/groups/modals/group-modal").then((m) => m.CustomerGroupModal),
      ),
      confirmOnDirtyClose: true,
      closeConfirmMessage: "Discard unsaved group changes?",
    },
    {
      type: "customer-tag",
      component: dynamic(() =>
        import("@/domains/customers/tags/modals/tag-modal").then((m) => m.CustomerTagModal),
      ),
      confirmOnDirtyClose: true,
      closeConfirmMessage: "Discard unsaved tag changes?",
    },
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customer-content/reviews/modals/edit-review-content-modal").then(
          (m) => m.EditReviewContentModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customer-content/reviews/modals/edit-reviewer-modal").then(
          (m) => m.EditReviewerModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customer-content/reviews/modals/edit-review-subject-modal").then(
          (m) => m.EditReviewSubjectModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customer-content/reviews/modals/edit-review-ratings-modal").then(
          (m) => m.EditReviewRatingsModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customer-content/reviews/modals/edit-review-moderation-modal").then(
          (m) => m.EditReviewModerationModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customer-content/reviews/modals/edit-review-verification-modal").then(
          (m) => m.EditReviewVerificationModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customer-content/reviews/modals/edit-review-incentive-modal").then(
          (m) => m.EditReviewIncentiveModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customer-content/reviews/modals/edit-review-media-modal").then(
          (m) => m.EditReviewMediaModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customer-content/reviews/modals/edit-review-media-item-modal").then(
          (m) => m.EditReviewMediaItemModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customer-content/reviews/modals/review-technical-metadata-modal").then(
          (m) => m.ReviewTechnicalMetadataModal,
        ),
      ),
    },
    {
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customer-content/management/criteria").then(
          (m) => m.RatingCriterionModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customer-content/management/external").then(
          (m) => m.ExternalReferenceModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/customer-content/management/insights").then(
          (m) => m.ProductInsightsModal,
        ),
      ),
    },
    // ========================================
    ...
    // ========================================
    {
      ...
      component: dynamic(() =>
        import("@/domains/sales/fulfillment/stages/modals/stage-modal").then(
          (m) => m.FulfillmentStageModal,
        ),
      ),
      confirmOnDirtyClose: true,
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/sales/all-orders/modals/fulfillment-status-modal").then(
          (m) => m.OrderFulfillmentStatusModal,
        ),
      ),
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/sales/all-orders/modals/shipping-item-modal").then(
          (m) => m.OrderShippingItemModal,
        ),
      ),
    },
    // ========================================
    ...
    },
    {
      type: "order-status",
      component: dynamic(() =>
        import("@/domains/sales/all-orders/modals/order-status-modal").then(
          (m) => m.OrderStatusModal,
        ),
      ),
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/sales/all-orders/modals/payment-status-modal").then(
          (m) => m.OrderPaymentStatusModal,
        ),
      ),
    },
    {
    ...
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/sales/all-orders/modals/shipping-details-modal").then(
          (m) => m.OrderShippingDetailsModal,
        ),
      ),
    },
    {
      ...
      component: dynamic(() =>
        import("@/domains/sales/all-orders/modals/payment-details-modal").then(
          (m) => m.OrderPaymentDetailsModal,
        ),
      ),
    },
    // ========================================
    ...
    // Upload Media modal
    {
      type: "media-upload",
      component: dynamic(() =>
        import("@/domains/media/modals/upload-media-modal").then((m) => m.UploadMediaModal),
      ),
    },
  ];
}
