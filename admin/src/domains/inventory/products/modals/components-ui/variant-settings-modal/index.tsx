...
import type { IComponentItemVariantSettingsModalPayload } from "@/domains/inventory/products/modals";
...
type PriceType = ComponentPriceType;
...
const calculateFinalPrice = (
  ...
  switch (priceType) {
    ...
    case ComponentPriceType.Fixed:
      return priceValue ?? 0;
    case ComponentPriceType.DiscountPercent:
      return basePrice * (1 - (priceValue ?? 0) / 100);
    case ComponentPriceType.DiscountFixed:
...
export const VariantSettingsModal = () => {
  ...
  const modalPayload = payload as IComponentItemVariantSettingsModalPayload | undefined;
  ...
  return (
    <ModalLayout
      name="component-item-variant-settings"
      header={
        <ModalHeader
          name="component-item-variant-settings"
