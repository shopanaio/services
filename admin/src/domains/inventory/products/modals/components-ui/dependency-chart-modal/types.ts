...
export type SelectedNodeType = "rule" | "item" | "group" | "component" | null;
...
export interface SelectedComponentNode {
  type: "component";
  label: string;
}
...
export type ChartNode = ItemNode | RuleNode | ComponentNode | HubNode;
