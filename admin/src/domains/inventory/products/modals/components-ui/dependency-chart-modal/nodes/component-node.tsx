...
const useStyles = createStyles(({ token }) => ({
  node: {
    ...
    width: NODE_DIMENSIONS.component.width,
    height: NODE_DIMENSIONS.component.height,
...
type ComponentNodeProps = NodeProps<Node<ComponentNodeData, "component">>;

const ComponentNodeComponent = ({ data, selected }: ComponentNodeProps) => {
