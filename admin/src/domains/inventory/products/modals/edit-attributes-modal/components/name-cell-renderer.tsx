...
export interface INameCellRendererParams extends ICellRendererParams<AttributeEditorRow> {
...
export const NameCellRenderer = (params: INameCellRendererParams) => {
  ...
  return (
    <div className={styles.nameCell}>
      ...
      {getIcon()}
      <span>{data.name}</span>
      {data.featured && <Badge className={styles.featuredBadge} color="gold" text="* Featured" />}
    </div>
  );
};
