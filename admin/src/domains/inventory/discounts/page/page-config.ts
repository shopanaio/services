...
> = {
  usageCount:
    createGraphqlIntFilterTransformer<ApiDiscountWhereInput>("usageCount"),
  startsAt:
    createGraphqlDateTimeRangeFilterTransformer<ApiDiscountWhereInput>(
      "startsAt",
    ),
  endsAt:
    createGraphqlDateTimeRangeFilterTransformer<ApiDiscountWhereInput>(
  ...
  channelCode:
    createGraphqlStringFilterTransformer<ApiDiscountWhereInput>("channelCode"),
  tag: createGraphqlStringFilterTransformer<ApiDiscountWhereInput>("tag"),
};

export const buildDiscountSearchCondition = (
  search: string,
): Partial<ApiDiscountWhereInput> => ({
  _or: [
