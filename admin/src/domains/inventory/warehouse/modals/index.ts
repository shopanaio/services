...
import type { WarehouseDetailsQueryVariables, WarehousesQueryVariables } from "../graphql";
...
export interface IWarehouseEditIdentityModalPayload extends IModalStackPayload {
...
export const useWarehouseCreateModal = createModalStackHook(WAREHOUSE_CREATE_MODAL_TYPE);
export const useWarehouseEditIdentityModal = createModalStackHook(
  WAREHOUSE_EDIT_IDENTITY_MODAL_TYPE,
);
export const useWarehouseEditDefaultModal = createModalStackHook(WAREHOUSE_EDIT_DEFAULT_MODAL_TYPE);
export const useWarehouseDeleteModal = createModalStackHook(WAREHOUSE_DELETE_MODAL_TYPE);
