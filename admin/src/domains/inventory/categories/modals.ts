...
export interface ICategoryEditIdentityModalPayload extends ICategoryEditModalPayload {
  onSave?: (values: CategoryIdentityFormValues) => boolean | void | Promise<boolean | void>;
}

export interface ICategoryEditContentModalPayload extends ICategoryEditModalPayload {
  onSave?: (values: CategoryContentFormValues) => boolean | void | Promise<boolean | void>;
}

export interface ICategoryEditSeoModalPayload extends ICategoryEditModalPayload {
  onSave?: (values: CategorySeoFormValues) => boolean | void | Promise<boolean | void>;
}

export interface ICategoryEditMediaModalPayload extends ICategoryEditModalPayload {
  onSave?: (values: CategoryMediaFormValues) => boolean | void | Promise<boolean | void>;
}

export interface ICategoryEditSortModalPayload extends ICategoryEditModalPayload {
  onSave?: (values: CategorySortFormValues) => boolean | void | Promise<boolean | void>;
}
...
export const useCategoryEditIdentityModal = createModalStackHook(CATEGORY_EDIT_IDENTITY_MODAL_TYPE);
export const useCategoryEditContentModal = createModalStackHook(CATEGORY_EDIT_CONTENT_MODAL_TYPE);
export const useCategoryEditSeoModal = createModalStackHook(CATEGORY_EDIT_SEO_MODAL_TYPE);
export const useCategoryEditMediaModal = createModalStackHook(CATEGORY_EDIT_MEDIA_MODAL_TYPE);
export const useCategoryEditSortModal = createModalStackHook(CATEGORY_EDIT_SORT_MODAL_TYPE);
