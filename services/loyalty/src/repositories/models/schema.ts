...
export const programVersionStatusEnum = loyaltySchema.enum(
...
export const debtPolicyEnum = loyaltySchema.enum("debt_policy", [
  "TRACK_DEBT",
  "REJECT_REVERSAL",
]);
export const restoredPointsExpiryPolicyEnum = loyaltySchema.enum(
...
export const lotAllocationTypeEnum = loyaltySchema.enum(
  "lot_allocation_type",
...
export const reservationEventTypeEnum = loyaltySchema.enum(
  "reservation_event_type",
  ["CREATED", "COMMITTED", "RELEASED", "EXPIRED", "REVERSED"],
);
export const tierMembershipStatusEnum = loyaltySchema.enum(
  "tier_membership_status",
  ["ACTIVE", "EXPIRED", "REVOKED"],
);
export const tierMembershipEventTypeEnum = loyaltySchema.enum(
  "tier_membership_event_type",
  ["QUALIFIED", "UPGRADED", "DOWNGRADED", "RENEWED", "EXPIRED", "REVOKED"],
);
export const earningTriggerTypeEnum = loyaltySchema.enum(
  "earning_trigger_type",
  [
    "ORDER",
    "SIGNUP",
    "REVIEW",
...
export const rewardEntitlementStatusEnum = loyaltySchema.enum(
  "reward_entitlement_status",
  ["ISSUED", "RESERVED", "REDEEMED", "EXPIRED", "REVOKED"],
);
export const rewardEntitlementEventTypeEnum = loyaltySchema.enum(
  "reward_entitlement_event_type",
  ["ISSUED", "RESERVED", "RELEASED", "REDEEMED", "EXPIRED", "REVOKED"],
);
export const tierEvaluationWindowTypeEnum = loyaltySchema.enum(
  "tier_evaluation_window_type",
  ["LIFETIME", "ROLLING", "CALENDAR"],
);
export const tierCalendarPeriodEnum = loyaltySchema.enum(
  "tier_calendar_period",
  ["MONTH", "QUARTER", "YEAR", "PROGRAM_YEAR"],
);
export const tierDowngradePolicyEnum = loyaltySchema.enum(
  "tier_downgrade_policy",
  ["IMMEDIATE", "GRACE_PERIOD", "END_OF_MEMBERSHIP"],
);
export const tierRequalificationPolicyEnum = loyaltySchema.enum(
  "tier_requalification_policy",
  ["AUTOMATIC", "MANUAL"],
);
export const monetaryWalletTypeEnum = loyaltySchema.enum(
  "monetary_wallet_type",
  ["CASHBACK", "STORE_CREDIT"],
);
export const monetaryWalletStatusEnum = loyaltySchema.enum(
  "monetary_wallet_status",
  ["ACTIVE", "SUSPENDED", "CLOSED", "MERGED"],
);
export const monetaryBalanceBucketEnum = loyaltySchema.enum(
  "monetary_balance_bucket",
  ["PENDING", "AVAILABLE", "RESERVED", "DEBT"],
);
export const monetaryTransactionKindEnum = loyaltySchema.enum(
  "monetary_transaction_kind",
  [
    "EARN_PENDING",
    "ACTIVATE",
    "RESERVE",
