...
export const configMutation = loyaltySchema.table("config_mutation", {
  ...
  unique("loyalty_config_mutation_identity_unique").on(table.storeId, table.operation, table.idempotencyKey),
