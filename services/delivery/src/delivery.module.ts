...
import {
  DELIVERY_CHECKOUT_FACTS,
  DELIVERY_FULFILLMENT,
  DELIVERY_PROVIDER_APPS,
...
} from "./workflows/DeliveryShipmentWorkflows.js";
  ...
  providers: [
    ...
    },
    {
      ...
      useFactory: (repository: Repository) =>
        new DeliveryProviderAssetPolicyService(repository.providerAccounts),
    },
    DeliveryShipmentTransitionPolicy,
    {
      ...
      useFactory: (
        policies: DeliveryProviderAssetPolicyService,
        assets: BrokerDeliveryProviderAssetsAdapter,
      ) => new DeliveryProviderObservationNormalizer({ policies, assets }),
    },
    {
      ...
      inject: [
        ...
        DELIVERY_PROVIDER_APPS,
        DeliveryShipmentTransitionPolicy,
        DeliveryProviderObservationNormalizer,
      ],
      useFactory: (
        repository: Repository,
        fulfillment: BrokerDeliveryFulfillmentAdapter,
        apps: BrokerDeliveryProviderAppsAdapter,
        transitions: DeliveryShipmentTransitionPolicy,
        normalizer: DeliveryProviderObservationNormalizer,
      ) => new DeliveryShipmentService({ repository, fulfillment, apps, transitions, normalizer }),
    },
    {
      ...
      useFactory: (
        repository: Repository,
        facts: BrokerDeliveryCheckoutFactsAdapter,
        apps: BrokerDeliveryProviderAppsAdapter,
        customization: DeliveryCustomizationRunner,
      ) =>
        new DeliveryCheckoutService({
          facts,
    ...
    },
    {
      ...
      useFactory: (repository: Repository, apps: BrokerDeliveryProviderAppsAdapter) =>
        new DeliverySelectionCommitService({
          bindings: repository.optionBindings,
          providerAccounts: repository.providerAccounts,
          apps,
        }),
    },
    {
      ...
      useFactory: (
        ...
        checkout: DeliveryCheckoutService,
        commitments: DeliverySelectionCommitService,
    ...
    },
    {
      ...
      inject: [Repository, DELIVERY_PROVIDER_APPS],
      useFactory: (repository: Repository, apps: BrokerDeliveryProviderAppsAdapter) =>
        new DeliveryProviderAccountService(repository, apps),
    },
    {
      ...
      useFactory: (
        broker: ServiceBroker,
        accounts: DeliveryProviderAccountService,
        repository: Repository,
...
function deliveryOptionHandleSecret(): string {
  ...
  if (process.env.NODE_ENV === "production")
    throw new Error("DELIVERY_OPTION_HANDLE_SECRET must contain at least 32 characters");
