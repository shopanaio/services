...
export const customizations = deliverySchema.table(
  "customizations",
  {
...
export const customizationBindings = deliverySchema.table(
  ...
  (table) => [
    unique("customization_bindings_owner_sequence_key").on(
