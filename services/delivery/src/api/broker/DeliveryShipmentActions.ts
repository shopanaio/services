...
export class DeliveryShipmentActions extends BrokerActions {
  ...
  create(params: Delivery.CreateDeliveryShipmentParams) {
    return this.broker.runWorkflow<Delivery.CreateDeliveryShipmentResult>(
      "delivery.createShipment",
      params,
      workflowOptions("create", params.storeId, params.fulfillmentOrderId, params),
    );
  }
  ...
  cancel(params: Delivery.CancelDeliveryShipmentParams) {
    return this.broker.runWorkflow<Delivery.DeliveryOperationAcceptedResult>(
      "delivery.cancelShipment",
      params,
      workflowOptions("cancel", params.storeId, params.shipmentId, params),
    );
  }
  ...
  reconcile(params: Delivery.ReconcileDeliveryShipmentParams) {
    return this.broker.runWorkflow<Delivery.DeliveryOperationAcceptedResult>(
      "delivery.reconcileShipment",
      params,
      workflowOptions("reconcile", params.storeId, params.shipmentId, params),
    );
  }

  @Action(DeliveryActionNames.getShipment)
  @ZodSchema(DeliveryLifecycleActionSchemas.getShipment)
  get(params: Delivery.GetDeliveryShipmentParams) {
    return this.shipments.get(params);
  }
  ...
  private startOutbox(
    ...
    return this.broker.startWorkflow(
      ...
      { organizationId, storeId, shipmentId, correlationId },
      {
        source: "content",
        organizationId,
        resourceId: shipmentId,
        operation: "delivery.publishShipmentOutbox",
        content: { shipmentId, callId },
      },
    );
  }
}
