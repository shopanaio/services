...
export interface DeliveryFulfillmentOrderLifecyclePort {
  submitFulfillmentRequest(input: Readonly<{
    storeId: string;
    fulfillmentOrderId: string;
  ...
  acceptFulfillmentRequest(input: Readonly<{
    storeId: string;
    fulfillmentOrderId: string;
    expectedRevision: number;
    message: string | null;
  ...
  rejectFulfillmentRequest(input: Readonly<{
    storeId: string;
    fulfillmentOrderId: string;
    expectedRevision: number;
  ...
  submitCancellationRequest(input: Readonly<{
    storeId: string;
    fulfillmentOrderId: string;
    expectedRevision: number;
    message: string | null;
  ...
  acceptCancellationRequest(input: Readonly<{
    storeId: string;
    fulfillmentOrderId: string;
    expectedRevision: number;
    message: string | null;
  ...
  rejectCancellationRequest(input: Readonly<{
    storeId: string;
    fulfillmentOrderId: string;
    expectedRevision: number;
    message: string | null;
  ...
  holdFulfillmentOrder(input: Readonly<{
    storeId: string;
    fulfillmentOrderId: string;
    expectedRevision: number;
  ...
  releaseFulfillmentOrderHold(input: Readonly<{
    storeId: string;
    fulfillmentOrderId: string;
    expectedRevision: number;
    holdId: string;
  ...
  moveFulfillmentOrder(input: Readonly<{
    storeId: string;
    fulfillmentOrderId: string;
    expectedRevision: number;
  ...
  mergeFulfillmentOrders(input: Readonly<{
    storeId: string;
  ...
  closeFulfillmentOrder(input: Readonly<{
    storeId: string;
    fulfillmentOrderId: string;
    expectedRevision: number;
    message: string | null;
  ...
  markFulfillmentOrderIncomplete(input: Readonly<{
    storeId: string;
    fulfillmentOrderId: string;
    expectedRevision: number;
    message: string | null;
