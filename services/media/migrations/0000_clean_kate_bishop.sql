...
CREATE UNIQUE INDEX "idx_buckets_active_per_project" ON "media"."buckets" USING btree ("project_id") WHERE status = 'active' AND deleted_at IS NULL;--> statement-breakpoint
CREATE INDEX "idx_buckets_project_id" ON "media"."buckets" USING btree ("project_id");--> statement-breakpoint
CREATE INDEX "idx_buckets_status" ON "media"."buckets" USING btree ("project_id","status") WHERE deleted_at IS NULL;--> statement-breakpoint
