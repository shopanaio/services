 ...
 *
 * @example
 * class FileConnectionResolver extends BaseConnectionResolver<FileRelayInput> {
 ...
 * }
 */
export abstract class BaseConnectionResolver<TArgs = unknown> extends MediaType<
  TArgs,
  ConnectionData
> {
  /**
