...
CREATE TABLE "catalog"."warehouse_stock" (
  ...
  CONSTRAINT "warehouse_stock_store_id_warehouse_id_variant_id_key"
    UNIQUE ("store_id", "warehouse_id", "variant_id"),
...
CREATE INDEX "idx_stock_changes_idempo_lookup"
  ON "catalog"."stock_changes" ("store_id", "source_system", "source_event_id");
...
CREATE INDEX "idx_stock_changes_store_seq"
  ON "catalog"."stock_changes" ("store_id", "seq");
