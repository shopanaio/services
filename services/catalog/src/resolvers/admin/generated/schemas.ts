...
export const CollectionRuleOperatorSchema = z.nativeEnum(CollectionRuleOperator);
...
export function ProductOptionCategoryDeleteInputSchema(): z.ZodObject<Properties<ProductOptionCategoryDeleteInput>> {
  return z.object({
    id: z.string()
  })
}
