...
export const resolveCheckoutDeliveryFactsParamsSchema: z.ZodType<Catalog.ResolveCheckoutDeliveryFactsParams> =
  z
    .object({
      storeId: identifier,
    ...
    .superRefine((value, context) => {
      ...
      if (new Set(lineIds).size !== lineIds.length)
        context.addIssue({
          ...
          path: ["lines"],
          message: "Delivery fact line IDs must be unique",
        });
    });
