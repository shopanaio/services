...
import type { BulkEditJob, BulkEditItem } from "../repositories/models/index.js";
import {
  emptyProgressCounts,
...
export class BulkEditLoader {
  ...
  constructor(repository: Repository) {
    ...
    this.bulkEditJobProgress = new DataLoader<string, BulkEditJobProgressCounts>(async (jobIds) => {
    ...
    this.bulkEditJobTotalProducts = new DataLoader<string, number>(async (jobIds) => {
