...
export const stockMovementTypeEnum = catalogSchema.enum("stock_movement_type", [
  "SEED",
  "RECEIVE",
  "SELL",
  "RETURN",
...
export const stockMovementReasonEnum = catalogSchema.enum("stock_movement_reason", [
  "DAMAGE",
  "INVENTORY_COUNT",
  "MANUAL",
  "CUSTOMER_RETURN",
