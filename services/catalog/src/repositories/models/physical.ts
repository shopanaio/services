...
export const dimensionUnitEnum = catalogSchema.enum("dimension_unit", [
  "mm",
  "cm",
  "m",
  "in",
...
export const weightUnitEnum = catalogSchema.enum("weight_unit", ["g", "kg", "lb", "oz"]);

export const itemDimensions = catalogSchema.table(
  "item_dimensions",
  {
