...
import type { TagCreateScriptParams, TagCreateScriptResult } from "../dto/index.js";

export class TagCreateScript extends BaseScript<TagCreateScriptParams, TagCreateScriptResult> {
  @Transactional()
  protected async execute(params: TagCreateScriptParams): Promise<TagCreateScriptResult> {
  ...
  protected handleError(_error: unknown): TagCreateScriptResult {
    return {
      tag: undefined,
