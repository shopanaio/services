...
import type {
  ProductComparisonConfigurationMappingInput,
...
export class ProductComparisonConfigurationSyncScript extends BaseScript<
  ProductComparisonConfigurationSyncParams,
  Result
> {
  @Transactional()
  protected async execute(params: ProductComparisonConfigurationSyncParams): Promise<Result> {
  ...
  private async validateSource(
    ...
    mapping: ProductComparisonConfigurationMappingInput,
    index: number,
