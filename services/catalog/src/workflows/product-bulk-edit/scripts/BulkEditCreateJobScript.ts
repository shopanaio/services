...
import type { ProductBulkUpdateItem } from "../dto/BulkEditWorkflowDto.js";
import type { ProductUpdateOperation } from "../../product-update/dto/ProductUpdateWorkflowDto.js";
...
function getOperationMetadata(op: ProductUpdateOperation): {
  ...
  if (op.type === "productComparisonConfigurationSync") {
    return { opType: "productComparisonConfigurationSync", variantId: null };
  }
  if (
