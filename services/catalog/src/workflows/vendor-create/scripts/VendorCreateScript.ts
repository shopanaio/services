...
import type { VendorCreateScriptParams, VendorCreateScriptResult } from "../dto/index.js";

export class VendorCreateScript extends BaseScript<
  VendorCreateScriptParams,
  VendorCreateScriptResult
> {
  @Transactional()
  protected async execute(params: VendorCreateScriptParams): Promise<VendorCreateScriptResult> {
  ...
  protected handleError(_error: unknown): VendorCreateScriptResult {
    return {
      vendor: undefined,
