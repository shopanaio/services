...
export class ProductReviewSummaryResolver extends ReviewsType<ProductReviewSummaryAggregate> {
  product() {
    return productReference(this.$props.summary.productId);
  }
  reviewCount() {
    return this.$props.summary.reviewCount;
  }
  verifiedReviewCount() {
    return this.$props.summary.verifiedReviewCount;
  }
  mediaReviewCount() {
    return this.$props.summary.mediaReviewCount;
  }
  ratingSum() {
    return this.$props.summary.ratingSum.toString();
  }
  averageRating() {
    return this.$props.summary.averageRating;
  }
  ratingBreakdown() {
    return ratingBreakdown(this.$props.summary);
  }
  criteria() {
  ...
  lastReviewedAt() {
    return this.$props.summary.lastReviewedAt;
  }
  updatedAt() {
    return this.$props.summary.updatedAt;
  }
}
...
export class ProductRatingCriterionSummaryResolver extends ReviewsType<ProductRatingCriterionSummary> {
  ...
  ratingSum() {
    return this.$props.ratingSum.toString();
  }
  averageRating() {
    return this.$props.averageRating;
  }
  ratingBreakdown() {
    return ratingBreakdown(this.$props);
  }
  updatedAt() {
...
export class ProductQuestionSummaryResolver extends ReviewsType<ProductQuestionSummary> {
  ...
  answeredQuestionCount() {
    return this.$props.answeredQuestionCount;
  }
  unansweredQuestionCount() {
    return this.$props.unansweredQuestionCount;
  }
  answerCount() {
    return this.$props.answerCount;
  }
  officialAnswerCount() {
    return this.$props.officialAnswerCount;
  }
  lastQuestionAt() {
    return this.$props.lastQuestionAt;
  }
  lastAnsweredAt() {
