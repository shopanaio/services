...
> {
  @Transactional()
  protected async execute(params: ProductQuestionDeleteParams): Promise<ProductQuestionDeleteResult> {
    ...
    this.logger.info({ productQuestionId: params.id, permanent: params.permanent ?? false }, "Product question deleted");
    return {
