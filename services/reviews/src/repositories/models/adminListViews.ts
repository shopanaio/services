...
export const contentListView = reviewsSchema
  .view("content_list_view", contentListColumns)
  .as(sql`
    SELECT
      content.store_id,
      content.id,
...
export const reviewListView = reviewsSchema
  .view("review_list_view", {
    ...contentListColumns,
...
export const reviewReplyListView = reviewsSchema
  .view("review_reply_list_view", {
...
export const productQuestionListView = reviewsSchema
  .view("product_question_list_view", {
    storeId: uuid("store_id").notNull(),
    id: uuid("id").notNull(),
    productId: uuid("product_id").notNull(),
    variantId: uuid("variant_id"),
...
export const productQuestionAnswerListView = reviewsSchema
  .view("product_question_answer_list_view", {
    ...contentAggregateListColumns,
...
export type ProductQuestionAnswerListView =
  typeof productQuestionAnswerListView.$inferSelect;
