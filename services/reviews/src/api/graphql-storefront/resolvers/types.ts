...
} from "../../../resolvers/storefront/ConfigurationResolver.js";
import {
  ContentPublicationResolver,
  ContentTranslationResolver,
} from "../../../resolvers/storefront/ContentResolver.js";
import {
  ContentReportResolver,
  ContentVoteResolver,
} from "../../../resolvers/storefront/EngagementResolver.js";
import {
...
} from "../../../resolvers/storefront/QuestionResolver.js";
import {
  ReviewMediaResolver,
  ReviewReplyResolver,
  ReviewResolver,
} from "../../../resolvers/storefront/ReviewResolver.js";
import {
  ReviewRequestEventResolver,
  ReviewRequestResolver,
} from "../../../resolvers/storefront/ReviewRequestResolver.js";
import {
  ContentRevisionResolver,
  ModerationCaseResolver,
  ModerationEventResolver,
  ModerationSignalResolver,
} from "../../../resolvers/storefront/ModerationResolver.js";
...
const referenceResolver =
  (entity: GlobalIdType, Resolver: Loadable) =>
...
const resolveNodeType = (value: unknown) =>
  value && typeof value === "object"
    ? (nodeTypes.get((value as object).constructor) ??
...
export const typeResolvers = {
  ...
  ReviewStoreConfiguration: {
    __resolveReference: async (
      ...
      return row?.id === id
        ? StoreConfigurationResolver.load(row, parseGraphqlInfo(info), ctx)
        : null;
    },
  },
