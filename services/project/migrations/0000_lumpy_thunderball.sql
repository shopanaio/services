...
CREATE TABLE "store"."locale" (
	...
	"code" "store"."locale_code" NOT NULL,
...
CREATE TABLE "store"."currency" (
	"store_id" uuid NOT NULL,
	"code" "store"."currency_code" NOT NULL,
	"is_active" boolean DEFAULT true NOT NULL,
...
CREATE TABLE "store"."store" (
	...
	"email" varchar(255),
	"default_locale" "store"."locale_code" NOT NULL,
	"base_currency" "store"."currency_code" NOT NULL,
	"default_currency" "store"."currency_code" NOT NULL,
