...
const manifest = [
  ...
  ["customer.draft_order.invoice", "Draft order invoice", event("draftOrderInvoiceRequested"), "CUSTOMER", false],
  ["customer.shipping.confirmation", "Shipping confirmation", event("orderFulfilled"), "CUSTOMER", false],
  ["customer.local_pickup.ready", "Ready for local pickup", event("localPickupReady"), "CUSTOMER", false],
  ["customer.local_pickup.picked_up", "Picked up by customer", event("localPickupCompleted"), "CUSTOMER", false],
  ["customer.local_delivery.out_for_delivery", "Order out for local delivery", event("localDeliveryStarted"), "CUSTOMER", true],
  ["customer.local_delivery.delivered", "Order locally delivered", event("localDeliveryCompleted"), "CUSTOMER", true],
  ["customer.local_delivery.missed", "Order missed local delivery", event("localDeliveryMissed"), "CUSTOMER", true],
  ["customer.gift_card.new", "New gift card", event("giftCardIssued"), "CUSTOMER", false],
  ["customer.gift_card.receipt", "Gift card receipt", event("giftCardRecipientAssigned"), "CUSTOMER", false],
  ["customer.store_credit.issued", "Store credit issued", event("storeCreditIssued"), "CUSTOMER", false],
  ...
  ["customer.order.payment_receipt", "Order payment receipt", event("orderPaymentReceiptRequested"), "CUSTOMER", false],
  ["customer.order.refund", "Order refund", event("orderRefunded"), "CUSTOMER", false],
  ["customer.checkout.abandoned", "Abandoned checkout", event("checkoutAbandoned"), "CUSTOMER", false],
  ...
  ["customer.payment.pending_error", "Pending payment error", event("pendingPaymentFailed"), "CUSTOMER", false],
  ["customer.payment.pending_success", "Pending payment success", event("pendingPaymentSucceeded"), "CUSTOMER", false],
  ["customer.payment.reminder", "Payment reminder", event("paymentReminderDue"), "CUSTOMER", false],
  ["customer.pos.abandoned_checkout", "POS abandoned checkout", event("posCheckoutAbandoned"), "CUSTOMER", false],
  ["customer.pos.email_to_customer", "POS email to customer", event("posCartEmailRequested"), "CUSTOMER", false],
  ["customer.pos.receipt", "POS and mobile receipt", event("posReceiptRequested"), "CUSTOMER", false],
  ["customer.pos.exchange_receipt", "POS exchange receipt", event("posExchangeReceiptRequested"), "CUSTOMER", false],
  ["customer.shipping.updated", "Shipping update", event("shippingTrackingUpdated"), "CUSTOMER", false],
  ["customer.shipping.out_for_delivery", "Out for delivery", event("shipmentOutForDelivery"), "CUSTOMER", true],
  ...
  ["customer.return.order_label_created", "Order-level return label created", event("returnLabelCreated"), "CUSTOMER", false],
  ["customer.return.request_received", "Return request received", event("returnRequestReceived"), "CUSTOMER", false],
  ["customer.return.request_approved", "Return request approved", event("returnRequestApproved"), "CUSTOMER", false],
  ["customer.return.request_declined", "Return request declined", event("returnRequestDeclined"), "CUSTOMER", false],
  ["customer.change_request.received", "Change request received", event("orderChangeRequestReceived"), "CUSTOMER", false],
  ["customer.cancellation_request.declined", "Cancellation request declined", event("cancellationRequestDeclined"), "CUSTOMER", false],
  ["customer.account.invite", "Customer account invite", action(), "CUSTOMER", false],
  ["customer.account.welcome", "Customer account welcome", event("customerAccountActivated"), "CUSTOMER", false],
  ["customer.account.password_reset", "Customer account password reset", action(), "CUSTOMER", false],
  ["customer.account.payment_method_add_request", "Customer payment method add request", action(), "CUSTOMER", false],
  ["customer.b2b.access", "B2B access email", event("b2bAccessGranted"), "CUSTOMER", false],
  ["customer.b2b.location_payment_method_update", "B2B location payment method update", action(), "CUSTOMER", false],
  ["customer.contact", "Contact customer", action(), "CUSTOMER", false],
  ["customer.email_change.confirmation", "Customer email change confirmation", action(), "CUSTOMER", false],
  ...
  ["customer.auth.new_login_alert", "New login alert", event("customerNewLoginDetected"), "CUSTOMER", true],
