...
import { eventHandlers, NotificationIngressService } from "./handlers/index.js";
...
@Module({
  imports: [ScheduleModule.forRoot(), BrokerModule.forFeature({ serviceName: "notifications" })],
  providers: [
