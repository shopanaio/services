...
@Injectable()
export class CheckoutNestService implements OnModuleInit, OnApplicationBootstrap, OnModuleDestroy {
    ...
    this.broker.register(
      ...
      async (
        ...
        if (
          ...
          context.caller.service !== "payments" ||
          context.app
        ) {
        ...
        if (
          ...
          return {
            ...
            failure: {
              ...
              message:
                "Checkout, quote, or settlement deadline changed before payment confirmation.",
              retryable: false,
              providerCode: null,
            },
          };
