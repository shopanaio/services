...
import type { ApiCheckoutMutationCheckoutDeliveryAddressesUpdateArgs, ApiCheckoutMutation } from "@src/interfaces/gql-storefront-api/types";
...
export const checkoutDeliveryAddressesUpdate = async (_parent: ApiCheckoutMutation, args: ApiCheckoutMutationCheckoutDeliveryAddressesUpdateArgs, ctx: GraphQLContext) => {
