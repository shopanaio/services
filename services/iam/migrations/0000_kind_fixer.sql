...
CREATE UNIQUE INDEX "idx_application_org_name" ON "iam"."application" USING btree ("organization_id","name");--> statement-breakpoint
...
CREATE UNIQUE INDEX "idx_organization_name" ON "iam"."organization" USING btree ("name");--> statement-breakpoint
