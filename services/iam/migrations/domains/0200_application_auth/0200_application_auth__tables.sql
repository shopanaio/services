...
CREATE TABLE "iam"."application_auth_configuration" (
	...
	"phone_otp_sign_in_enabled" boolean DEFAULT false NOT NULL,
	"phone_otp_sign_up_enabled" boolean DEFAULT false NOT NULL,
	...
	CONSTRAINT "application_auth_configuration_phone_otp_flags_check" CHECK (NOT "iam"."application_auth_configuration"."phone_otp_sign_up_enabled" OR "iam"."application_auth_configuration"."phone_otp_sign_in_enabled"),
