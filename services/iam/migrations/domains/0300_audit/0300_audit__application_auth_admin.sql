...
CREATE INDEX "idx_application_auth_admin_audit_org_occurred" ON "iam"."application_auth_admin_audit" USING btree ("organization_id","occurred_at");
CREATE INDEX "idx_application_auth_admin_audit_application_occurred" ON "iam"."application_auth_admin_audit" USING btree ("application_id","occurred_at");
