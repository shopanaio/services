...
export const customerListView = customersSchema
  .view("customer_list_view", {
    ...
    totalOrdersCount: integer("total_orders_count").notNull(),
    completedOrdersCount: integer("completed_orders_count").notNull(),
    cancelledOrdersCount: integer("cancelled_orders_count").notNull(),
    ...
    monetaryOrdersCount: integer("monetary_orders_count").notNull(),
    totalSpentMinor: bigint("total_spent_minor", { mode: "bigint" }).notNull(),
    totalRefundedMinor: bigint("total_refunded_minor", {
      mode: "bigint",
    }).notNull(),
    netSpentMinor: bigint("net_spent_minor", { mode: "bigint" }).notNull(),
