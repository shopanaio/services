...
import type { CustomerSegment, CustomerSegmentMembership } from "../repositories/models/index.js";
...
export class CustomerSegmentLoader {
  ...
  constructor(repository: Repository) {
    ...
    this.segmentCustomersCount = new DataLoader(async (segmentIds) => {
      const counts = await repository.segment.countCurrentCustomersBySegmentIds(segmentIds);
