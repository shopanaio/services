...
import type { PricingKernelServices, RunScriptContext } from "./types.js";

export class Kernel extends BaseKernel<PricingKernelServices> {
  ...
  async runScript<TParams, TResult>(
    ScriptClass: new (services: PricingKernelServices) => BaseScript<TParams, TResult>,
    params: TParams,
