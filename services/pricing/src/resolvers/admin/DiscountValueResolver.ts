...
> {
  ...
  amountMinor() {
    return toGraphqlBigInt(this.$props.amountMinor);
  }
  allocationMethod() {
    return this.$props.allocationMethod;
  }
...
> {
  ...
  benefitQuantity() {
    return this.$props.benefitQuantity;
  }
  benefitStrategy() {
    return this.$props.benefitStrategy;
  }
  benefitOperation() {
    return this.$props.benefitOperation;
  }
  benefitValueType() {
    return this.$props.benefitValueType;
  }
  benefitPercentageBps() {
    return this.$props.benefitPercentageBps;
  }
  benefitAmountMinor() {
    return toGraphqlBigInt(this.$props.benefitAmountMinor);
  }
  usesPerOrderLimit() {
    return this.$props.usesPerOrderLimit;
  }
}
...
export class DiscountMinimumRequirementResolver extends PricingType<DiscountMinimumRequirement> {
  ...
  subtotalMinor() {
    return toGraphqlBigInt(this.$props.subtotalMinor);
  }
  quantity() {
...
export class DiscountTargetSelectionResolver extends PricingType<TargetSelectionResolverProps> {
  role() {
    return this.$props.selection.role;
  }
  targetType() {
    return this.$props.selection.targetType;
  }
  targets() {
    return this.$props.targets.map((target) => new DiscountTargetResolver(target, this.$ctx));
  }
}

export class DiscountTargetResolver extends PricingType<DiscountTarget> {
  targetId() {
    return encodeCatalogTargetId(this.$props);
  }
  targetType() {
    return this.$props.targetType;
  }
  target() {
    return catalogTargetReference(this.$props);
  }
  referenceStatus() {
    return this.$props.referenceStatus;
  }
  referenceStatusChangedAt() {
    return this.$props.referenceStatusChangedAt;
  }
  referenceCheckedAt() {
    return this.$props.referenceCheckedAt;
  }
  createdAt() {
...
export class DiscountBuyerContextResolver extends PricingType<BuyerContextResolverProps> {
  type() {
    return this.$props.context.contextType;
  }
  customers() {
  ...
  createdAt() {
    return this.$props.context.createdAt;
  }
  updatedAt() {
    return this.$props.context.updatedAt;
  }
}

export class DiscountEligibleCustomerResolver extends PricingType<DiscountEligibleCustomer> {
  customerId() {
    return encodeGlobalIdByType(this.$props.customerId, GlobalIdEntity.Customer);
  }
  customer() {
    return customerReference(this.$props.customerId);
  }
  referenceStatus() {
    return this.$props.referenceStatus;
  }
...
export class DiscountEligibleSegmentResolver extends PricingType<DiscountEligibleSegment> {
  segmentId() {
    return encodeGlobalIdByType(this.$props.segmentId, GlobalIdEntity.CustomerSegment);
  }
  referenceStatus() {
    return this.$props.referenceStatus;
  }
...
export class DiscountCombinationResolver extends PricingType<DiscountCombinationClass> {
  discountClass() {
    return this.$props.combinesWithClass;
  }
  createdAt() {
    return this.$props.createdAt;
  }
...
export class DiscountFunctionBindingResolver extends PricingType<DiscountFunctionBinding> {
  id() {
    return encodeGlobalIdByType(this.$props.id, GlobalIdEntity.DiscountFunctionBinding);
  }
  target() {
    return this.$props.target;
  }
  contractVersion() {
    return this.$props.contractVersion;
  }
  installationId() {
    return encodeGlobalIdByType(this.$props.installationId, GlobalIdEntity.AppInstallation);
  }
  functionKey() {
    return this.$props.functionKey;
  }
  precedence() {
    return this.$props.precedence;
  }
  activationSequence() {
    return toGraphqlBigInt(BigInt(this.$props.activationSequence));
  }
  status() {
    return this.$props.status;
  }
  failureMode() {
    return this.$props.failureMode;
  }
...
export class DiscountUsageSummaryResolver extends PricingType<DiscountUsageSummaryView> {
  usageLimit() {
    return toGraphqlBigInt(this.$props.usageLimit);
  }
  reservedCount() {
    return toGraphqlBigInt(this.$props.reservedCount);
  }
  committedCount() {
    return toGraphqlBigInt(this.$props.committedCount);
  }
  reversedCount() {
    return toGraphqlBigInt(this.$props.reversedCount);
  }
  netCommittedCount() {
    return toGraphqlBigInt(this.$props.netCommittedCount);
  }
  consumedCount() {
    return toGraphqlBigInt(this.$props.consumedCount);
  }
  remainingCount() {
