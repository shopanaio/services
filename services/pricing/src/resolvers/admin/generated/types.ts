...
/** Scaffold for pricing commands. Add domain fields in dedicated schema files. */
export type PricingMutation = {
  __typename?: 'PricingMutation';
  /**
   * Scaffold-only field; remove after adding the first pricing mutation.
   * @deprecated Replace with pricing mutation fields
   */
  _placeholder: Scalars['Boolean']['output'];
};

/** Scaffold for pricing reads. Add domain fields in dedicated schema files. */
export type PricingQuery = {
  __typename?: 'PricingQuery';
  /**
   * Scaffold-only field; remove after adding the first pricing query.
   * @deprecated Replace with pricing query fields
   */
  _placeholder: Scalars['Boolean']['output'];
};
...
export type ResolversTypes = ResolversObject<{
  ...
  PricingMutation: ResolverTypeWrapper<PricingMutation>;
  Boolean: ResolverTypeWrapper<Scalars['Boolean']['output']>;
  PricingQuery: ResolverTypeWrapper<PricingQuery>;
...
export type PricingMutationResolvers<ContextType = ServiceContext, ParentType extends ResolversParentTypes['PricingMutation'] = ResolversParentTypes['PricingMutation']> = ResolversObject<{
  _placeholder?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
