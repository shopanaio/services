...
import {
  discountFunctionBindingStatusEnum,
  discountFunctionFailureModeEnum,
  discountFunctionTargetEnum,
  pricingSchema,
} from "./schema.js";

export const discountFunctionBinding = pricingSchema.table(
  "discount_function_binding",
  {
    id: uuid("id")
      .primaryKey()
      .default(sql`uuidv7()`),
...
export type DiscountFunctionBinding = typeof discountFunctionBinding.$inferSelect;
export type NewDiscountFunctionBinding = typeof discountFunctionBinding.$inferInsert;
