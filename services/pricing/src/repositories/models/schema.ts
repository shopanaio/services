...
export const discountMethodEnum = pricingSchema.enum("discount_method", [
  "CODE",
  "AUTOMATIC",
]);
...
export const discountEffectiveStatusEnum = pricingSchema.enum(
  "discount_effective_status",
  ["DRAFT", "SCHEDULED", "ACTIVE", "PAUSED", "EXPIRED", "ARCHIVED"],
);

export const discountCodeStatusEnum = pricingSchema.enum(
...
export const discountRequirementTypeEnum = pricingSchema.enum(
  "discount_requirement_type",
  ["SUBTOTAL", "QUANTITY"],
);

export const discountTargetRoleEnum = pricingSchema.enum(
  "discount_target_role",
  ["QUALIFIER", "BENEFIT"],
);
...
export const discountBuyerContextTypeEnum = pricingSchema.enum(
  "discount_buyer_context_type",
  ["ALL", "CUSTOMERS", "SEGMENTS"],
);

export const referenceStatusEnum = pricingSchema.enum("reference_status", [
  "VALID",
  "STALE",
]);

export const discountReservationStatusEnum = pricingSchema.enum(
  "discount_reservation_status",
  ["ACTIVE", "COMMITTED", "RELEASED", "EXPIRED"],
);

export const discountRedemptionStatusEnum = pricingSchema.enum(
...
export const externalSyncDirectionEnum = pricingSchema.enum(
  "external_sync_direction",
  ["IMPORT", "EXPORT", "BIDIRECTIONAL"],
);

export const externalSyncStatusEnum = pricingSchema.enum(
