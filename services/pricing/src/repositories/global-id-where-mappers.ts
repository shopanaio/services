...
export const decodeDiscountGlobalId = createGlobalIdWhereFieldMapper(GlobalIdEntity.Discount);
export const decodeDiscountCodeGlobalId = createGlobalIdWhereFieldMapper(
  GlobalIdEntity.DiscountCode,
);
export const decodeDiscountUsageReservationGlobalId = createGlobalIdWhereFieldMapper(
...
export const decodeDiscountExternalReferenceGlobalId = createGlobalIdWhereFieldMapper(
...
export const decodeCheckoutGlobalId = createGlobalIdWhereFieldMapper(GlobalIdEntity.Checkout);
