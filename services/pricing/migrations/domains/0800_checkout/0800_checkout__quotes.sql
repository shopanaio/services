...
CREATE TABLE "pricing"."checkout_preliminary_quote" (
  ...
  CONSTRAINT "checkout_preliminary_quote_attempt_unique" UNIQUE ("store_id", "checkout_id", "execution_id"),
...
CREATE TABLE "pricing"."checkout_final_quote" (
  ...
  CONSTRAINT "checkout_final_quote_attempt_unique" UNIQUE ("store_id", "checkout_id", "execution_id"),
