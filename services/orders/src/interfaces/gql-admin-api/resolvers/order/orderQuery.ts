...
import type { ApiOrderQueryOrderArgs, ApiOrderQuery } from "@src/interfaces/gql-admin-api/types";
import { mapOrderReadToApi } from "@src/interfaces/gql-admin-api/mapper/order";

/**
 * order(id: ID!): Order
 */
export const order = async (_parent: ApiOrderQuery, args: ApiOrderQueryOrderArgs) => {
