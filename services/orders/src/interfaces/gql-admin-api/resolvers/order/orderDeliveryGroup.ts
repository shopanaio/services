...
/**
 * selectedDeliveryMethod: OrderDeliveryMethod
 *
 * Returns the selected delivery method for the group (can be null)
 */
export const selectedDeliveryMethod = async (parent: ApiOrderDeliveryGroup) => {
 ...
 */
export const estimatedCost = async (parent: ApiOrderDeliveryGroup) => {
 ...
 */
export const deliveryMethods = async (parent: ApiOrderDeliveryGroup, _args: {}, ctx: GraphQLContext) => {
  try {
