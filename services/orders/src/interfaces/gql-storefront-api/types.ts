...
export type ApiResolversInterfaceTypes<_RefType extends Record<string, unknown>> = {
  ...
  Node:
    | ApiOrder
    | ApiOrderDeliveryAddress
    | ApiOrderDeliveryGroup
    | ApiOrderFulfillment
    | ApiOrderLine
    | ApiOrderPaymentTransaction
    | ApiOrderRefund
    | ApiOrderReturnRequest
    | ApiOrderShipment
    | ApiOrderTrackingEvent
    | ApiOrderVoid;
};
...
> = {
  __resolveType: TypeResolveFn<
    "OrderConnection" | "OrderReturnRequestConnection",
    ParentType,
    ContextType
  >;
...
> = {
  ...
  orders: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<ApiCustomerOrdersArgs, "first">
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
> = {
  orderCancel: Resolver<
    ApiResolversTypes["OrderCancelPayload"],
    ParentType,
    ContextType,
    RequireFields<ApiMutationOrderCancelArgs, "input">
  >;
  orderPaymentRetry: Resolver<
    ApiResolversTypes["OrderPaymentRetryPayload"],
    ParentType,
    ContextType,
    RequireFields<ApiMutationOrderPaymentRetryArgs, "input">
  >;
  orderReorder: Resolver<
    ApiResolversTypes["OrderReorderPayload"],
    ParentType,
    ContextType,
    RequireFields<ApiMutationOrderReorderArgs, "input">
  >;
  orderReturnRequestCancel: Resolver<
    ApiResolversTypes["OrderReturnRequestCancelPayload"],
    ParentType,
    ContextType,
    RequireFields<ApiMutationOrderReturnRequestCancelArgs, "input">
  >;
  orderReturnRequestCreate: Resolver<
    ApiResolversTypes["OrderReturnRequestCreatePayload"],
    ParentType,
    ContextType,
    RequireFields<ApiMutationOrderReturnRequestCreateArgs, "input">
  >;
};
...
> = {
  ...
  returnRequests: Resolver<
    ApiResolversTypes["OrderReturnRequestConnection"],
    ParentType,
    ContextType,
    RequireFields<ApiOrderReturnRequestsArgs, "first">
  >;
...
export type ApiOrderCancelPayloadResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderCancelPayload"] =
    ApiResolversParentTypes["OrderCancelPayload"],
> = {
...
export type ApiOrderConnectionResolvers<
  ContextType = GraphQLContext,
...
export type ApiOrderCostResolvers<
  ContextType = GraphQLContext,
...
export type ApiOrderDeliveryGroupResolvers<
  ContextType = GraphQLContext,
...
export type ApiOrderDeliveryMethodResolvers<
  ContextType = GraphQLContext,
...
export type ApiOrderEdgeResolvers<
  ContextType = GraphQLContext,
...
export type ApiOrderFulfillmentResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderFulfillment"] =
    ApiResolversParentTypes["OrderFulfillment"],
> = {
  createdAt: Resolver<ApiResolversTypes["DateTime"], ParentType, ContextType>;
  id: Resolver<ApiResolversTypes["ID"], ParentType, ContextType>;
...
export type ApiOrderFulfillmentLineResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderFulfillmentLine"] =
    ApiResolversParentTypes["OrderFulfillmentLine"],
> = {
...
> = {
  ...
  quantity: Resolver<ApiResolversTypes["Int"], ParentType, ContextType>;
  returnEligibility: Resolver<
    ApiResolversTypes["OrderLineReturnEligibility"],
    ParentType,
    ContextType
  >;
...
export type ApiOrderLineCostResolvers<
  ContextType = GraphQLContext,
...
export type ApiOrderLineReturnEligibilityResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderLineReturnEligibility"] =
    ApiResolversParentTypes["OrderLineReturnEligibility"],
> = {
...
export type ApiOrderPaymentResolvers<
  ContextType = GraphQLContext,
...
export type ApiOrderPaymentCustomerActionResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderPaymentCustomerAction"] =
    ApiResolversParentTypes["OrderPaymentCustomerAction"],
> = {
...
export type ApiOrderPaymentMethodResolvers<
  ContextType = GraphQLContext,
...
export type ApiOrderPaymentRetryResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderPaymentRetry"] =
    ApiResolversParentTypes["OrderPaymentRetry"],
> = {
...
export type ApiOrderPaymentRetryPayloadResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderPaymentRetryPayload"] =
    ApiResolversParentTypes["OrderPaymentRetryPayload"],
> = {
  attemptId: Resolver<Maybe<ApiResolversTypes["ID"]>, ParentType, ContextType>;
  customerAction: Resolver<
    Maybe<ApiResolversTypes["OrderPaymentCustomerAction"]>,
    ParentType,
    ContextType
  >;
  order: Resolver<Maybe<ApiResolversTypes["Order"]>, ParentType, ContextType>;
...
export type ApiOrderPaymentTransactionResolvers<
  ContextType = GraphQLContext,
...
export type ApiOrderPromoCodeResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderPromoCode"] =
    ApiResolversParentTypes["OrderPromoCode"],
> = {
...
export type ApiOrderRecipientResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderRecipient"] =
    ApiResolversParentTypes["OrderRecipient"],
> = {
  email: Resolver<Maybe<ApiResolversTypes["Email"]>, ParentType, ContextType>;
  firstName: Resolver<Maybe<ApiResolversTypes["String"]>, ParentType, ContextType>;
  lastName: Resolver<Maybe<ApiResolversTypes["String"]>, ParentType, ContextType>;
...
export type ApiOrderRefundResolvers<
  ContextType = GraphQLContext,
...
export type ApiOrderRefundLineResolvers<
  ContextType = GraphQLContext,
...
export type ApiOrderReorderPayloadResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderReorderPayload"] =
    ApiResolversParentTypes["OrderReorderPayload"],
> = {
  checkout: Resolver<Maybe<ApiResolversTypes["Checkout"]>, ParentType, ContextType>;
  skippedLines: Resolver<
    Array<ApiResolversTypes["OrderReorderSkippedLine"]>,
    ParentType,
    ContextType
  >;
  userErrors: Resolver<Array<ApiResolversTypes["OrderUserError"]>, ParentType, ContextType>;
...
export type ApiOrderReorderSkippedLineResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderReorderSkippedLine"] =
    ApiResolversParentTypes["OrderReorderSkippedLine"],
> = {
  code: Resolver<ApiResolversTypes["String"], ParentType, ContextType>;
  message: Resolver<ApiResolversTypes["String"], ParentType, ContextType>;
  orderLine: Resolver<ApiResolversTypes["OrderLine"], ParentType, ContextType>;
...
export type ApiOrderReturnRequestResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderReturnRequest"] =
    ApiResolversParentTypes["OrderReturnRequest"],
> = {
...
export type ApiOrderReturnRequestCancelPayloadResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderReturnRequestCancelPayload"] =
    ApiResolversParentTypes["OrderReturnRequestCancelPayload"],
> = {
...
export type ApiOrderReturnRequestConnectionResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderReturnRequestConnection"] =
    ApiResolversParentTypes["OrderReturnRequestConnection"],
> = {
...
export type ApiOrderReturnRequestCreatePayloadResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderReturnRequestCreatePayload"] =
    ApiResolversParentTypes["OrderReturnRequestCreatePayload"],
> = {
  order: Resolver<Maybe<ApiResolversTypes["Order"]>, ParentType, ContextType>;
  returnRequest: Resolver<Maybe<ApiResolversTypes["OrderReturnRequest"]>, ParentType, ContextType>;
  userErrors: Resolver<Array<ApiResolversTypes["OrderUserError"]>, ParentType, ContextType>;
...
export type ApiOrderReturnRequestEdgeResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderReturnRequestEdge"] =
    ApiResolversParentTypes["OrderReturnRequestEdge"],
> = {
  cursor: Resolver<ApiResolversTypes["Cursor"], ParentType, ContextType>;
...
export type ApiOrderReturnRequestLineResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderReturnRequestLine"] =
    ApiResolversParentTypes["OrderReturnRequestLine"],
> = {
  note: Resolver<Maybe<ApiResolversTypes["String"]>, ParentType, ContextType>;
  orderLine: Resolver<ApiResolversTypes["OrderLine"], ParentType, ContextType>;
  quantity: Resolver<ApiResolversTypes["Int"], ParentType, ContextType>;
...
export type ApiOrderSelfServiceResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderSelfService"] =
    ApiResolversParentTypes["OrderSelfService"],
> = {
...
export type ApiOrderSelfServiceActionResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderSelfServiceAction"] =
    ApiResolversParentTypes["OrderSelfServiceAction"],
> = {
  available: Resolver<ApiResolversTypes["Boolean"], ParentType, ContextType>;
  expiresAt: Resolver<Maybe<ApiResolversTypes["DateTime"]>, ParentType, ContextType>;
  unavailableReason: Resolver<Maybe<ApiResolversTypes["String"]>, ParentType, ContextType>;
...
export type ApiOrderShipmentResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderShipment"] =
    ApiResolversParentTypes["OrderShipment"],
> = {
...
export type ApiOrderTrackingEventResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderTrackingEvent"] =
    ApiResolversParentTypes["OrderTrackingEvent"],
> = {
...
export type ApiOrderTrackingInfoResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderTrackingInfo"] =
    ApiResolversParentTypes["OrderTrackingInfo"],
> = {
...
export type ApiOrderUserErrorResolvers<
  ContextType = GraphQLContext,
...
export type ApiOrderVoidResolvers<
  ContextType = GraphQLContext,
  ParentType extends ApiResolversParentTypes["OrderVoid"] = ApiResolversParentTypes["OrderVoid"],
> = {
  amount: Resolver<ApiResolversTypes["Money"], ParentType, ContextType>;
  createdAt: Resolver<ApiResolversTypes["DateTime"], ParentType, ContextType>;
  id: Resolver<ApiResolversTypes["ID"], ParentType, ContextType>;
...
> = {
  order: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<ApiQueryOrderArgs, "id">
  >;
  orderReturnRequest: Resolver<
    Maybe<ApiResolversTypes["OrderReturnRequest"]>,
    ParentType,
    ContextType,
    RequireFields<ApiQueryOrderReturnRequestArgs, "id">
  >;
};
